...
const HeroSection = () => {
  return (
    <section className="lg:py-24">
      <div className="flex flex-col-reverse md:flex-row justify-between gap-2 pb-12">
        <motion.div
        ...
        >
          <h1 className="mb-4 text-4xl sm:text-5xl lg:text-7xl lg:leading-normal font-extrabold">
            ...
            <br></br>
            <TypeAnimation
              sequence={["Mehrnaz Vaziri", 1000, "Frontend Developer", 1000]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
            />
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-lg">
            I'm a 23-year-old developer with a passion for coding, continuous
